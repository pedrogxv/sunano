      ...
      entries: [
        {
          ...
          description: "O mês abriu com o lançamento oficial da fase Alpha do Sunano — o site ganhou uma tag permanente no topo pra deixar isso claro — e seguiu com novidades em eventos, fórum, perfis e segurança.",
          items: [
            ...
            "Eventos resgatáveis com Aura: gaste a Aura que você ganhou no fórum para levar a medalha",
            '"Conquistas em destaque" na Home, com anel de progresso das vagas e marca nas que você já resgatou',
            "Sistema de auras (reações) no fórum",
            "Respostas em comentários do fórum, em threads de um nível",
            "Menu de compartilhar nos posts: copiar link, WhatsApp, X e o compartilhamento nativo do celular",
            'Diretório de Pessoas agora abre no ranking "Mais Aura", com pódio para o top 3',
            "Mini Perfil: passe o cursor sobre um avatar para ver bio e contadores, com fundo personalizável",
            "Perfil com grade de estatísticas (Aura, posts, comentários, favoritos e seguidores) e enquadramento da foto e do banner por arrastar e zoom",
            ...
            '2FA com "lembrar este dispositivo" por 30 dias, revogável a qualquer momento nas Configurações',
            ...
            "Cadastro por e-mail destravado: a conta é criada mesmo quando o e-mail de confirmação não sai, e dá pra reenviar",
            "Correções de cadastro, login e uploads com mensagens de erro mais claras, e sem perder o que já foi digitado",
          ],
        },
        {
          version: "Julho 2026",
      ...
      entries: [
        {
          ...
          description: "The month opened with the official Alpha launch of Sunano — the site now carries a permanent tag up top to make that clear — and kept going with updates to events, forum, profiles, and security.",
          items: [
            ...
            "Aura-redeemable events: spend the Aura you earned on the forum to take the medal home",
            '"Featured achievements" on the Home page, with a progress ring for remaining spots and a mark on the ones you already claimed',
            "Forum aura (reactions) system",
            "Replies on forum comments, in single-level threads",
            "Share menu on posts: copy link, WhatsApp, X, and your phone's native share sheet",
            'The people directory now opens on the "Most Aura" ranking, with a podium for the top 3',
            "Mini profile: hover an avatar to see bio and counters, with a customizable background",
            "Profiles now show a stats grid (Aura, posts, comments, favorites, and followers) and let you frame your photo and banner by dragging and zooming",
            "LGPD consent flow with logging and verification, plus a compliance audit",
            "Account deletion with email confirmation",
            '2FA with "remember this device" for 30 days, revocable at any time in Settings',
            ...
            "Email signup unblocked: your account is created even when the confirmation email doesn't go out, and you can resend it",
            "Clearer error messages for signup, login, and uploads — without losing what you already typed",
          ],
        },
        {
          version: "July 2026",
