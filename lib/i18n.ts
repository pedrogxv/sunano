  ...
  "pt-BR": {
    ...
    admin: {
      ...
      tierlistForm: {
        ...
        linkedStoreProduct: "Produtos da Loja vinculados",
      ...
      tierlistPage: {
        ...
        noPriceBandDesc: "Preço abaixo de R$50 (ou não preenchido): não cai em nenhuma faixa. Arraste para uma faixa ou corrija o preço no formulário.",
    ...
    changelog: {
      ...
      entries: [
        ...
        },
        {
          ...
          description: "A tierlist pessoal (VIP) saiu do card resumido no perfil e ganhou uma aba própria dentro da Tierlist, com tiers totalmente seus (nome, cor e quantidade) e um botão para baixar o board pronto para compartilhar.",
          items: [
            "Nova aba \"Minha Tierlist\" dentro de /tierlist reúne a tierlist pessoal (exclusiva VIP) num só lugar, no lugar do card resumido que ficava no perfil",
            "Tiers totalmente seus: renomeie, escolha qualquer cor, tenha de 2 a 6 tiers, e adicione, remova ou reordene do jeito que quiser",
            "Botão \"Baixar imagem\" gera um PNG pronto pra compartilhar, com até 6 periféricos por linha pra não ficar comprido demais",
            "Perfil de outros membros ganhou de volta o link \"Ver tierlist\", mostrado sempre que a pessoa já classificou algum periférico",
          ],
        },
        {
          version: "v0.3.8",
        ...
        },
        {
          ...
          items: [
            ...
            "Nas primeiras semanas a busca de GIF pode ficar indisponível por alguns minutos em horários de pico, e isso vai deixando de acontecer com o tempo. Quando acontece, é só tentar de novo mais tarde; o resto do comentário/post funciona normalmente",
          ],
        },
        {
          version: "v0.3.6",
          ...
          description: "Periféricos ganharam a categoria Fontes com ficha técnica de bancada, e a categoria IEM recebeu campos e tags próprias. O programa de afiliados ganhou link de compartilhamento e uma tela de saques reformulada, e o checkout passou a aceitar endereço de entrega preenchido depois da compra.",
          items: [
            "Nova categoria Fontes (⚡ psu) na Tierlist e no banco de periféricos: ficha técnica de bancada (ripple, eficiência e temperatura em carga normal, sobrecarga e teste máximo), selos 80 Plus e Cybenetics, e abas Geral, Nacional e Custo Benefício",
            "Categoria IEM ganhou campos próprios (drivers, impedância, sensibilidade, conector, plug, material, microfone) e curva de tuning, além de dezenas de tags novas de assinatura sonora e construção do shell",
            "\"Comentários do Sunano\" virou \"Comentários de Especialista\" em todas as categorias de periférico, com autor opcional exibido junto ao comentário",
            "Botão \"Copiar link de afiliado\" disponível em qualquer página pra quem já foi aprovado no programa, gerando o link com seu código de indicação embutido",
            "Tela de saques de afiliado reformulada: chave PIX validada e mascarada por tipo, cancelamento de saque ainda em análise, valor mínimo de R$20 e até 3 saques simultâneos pendentes",
            "Nova página com todas as reviews de um periférico, além do carrossel de destaques que já existia na página do produto",
            "Checkout: quem pula o endereço de entrega na hora da compra pode preenchê-lo depois em \"Meus Pedidos\"",
            "Checkout/carrinho: remover um item específico (lixeira ou reduzir a quantidade a zero) agora pede confirmação; já limpar o carrinho inteiro deixou de pedir",
            "Tela de pagamento via PIX ganhou contagem regressiva visual do prazo antes de expirar",
            "Corrigido: o preço promocional não aparecia no \"a partir de\" de produtos vinculados a um periférico",
            "Galeria de fotos do periférico reformulada: clique pra dar zoom e arraste pra navegar pela imagem ampliada, no lugar da lupa que seguia o mouse",
            "Home: os números da comunidade (periféricos, reviews, tópicos) agora aparecem sobre qualquer slide do carrossel de banners, e a faixa separada abaixo dele foi removida",
            "Admin: produtos podem ser fixados na seção \"Mais vendidos\" da Home, com reordenação manual por arrastar",
          ],
        },
        {
          version: "v0.3.5",
        ...
        },
        {
          ...
          description: "O Sunano aplicou a primeira onda de banimentos, a Damnatio Memoriae, contra contas flagradas farmando Aura de forma artificial, com multicontas e automação para inflar saldo, ofensiva e posição nos rankings.",
          items: [
            "Damnatio Memoriae: primeira leva de banimentos aplicada contra contas que farmavam Aura de forma artificial, com multicontas e automação (bots) para gerar curtidas, comentários e missões diárias em massa, inflando saldo, ofensiva e posição nos rankings sem uso legítimo do site",
        ...
        },
        {
          version: "v0.3.3",
          date: "19 de agosto",
          title: "Grupos de variantes, pré-venda e posts salvos no fórum",
          description: "A loja ganhou grupos de variantes combináveis (ex.: Cor + Tamanho), tipo de venda (pronta entrega/pré-venda) e uma nova página de Suporte; o fórum ganhou posts salvos, e um bug de menu fixo na loja foi corrigido.",
          items: [
            ...
            "Grupos de variantes: um produto pode ter mais de um grupo de opção ao mesmo tempo (ex.: Cor e Tamanho), cada grupo com suas próprias opções e ajuste de preço",
            "Tipo de venda por produto: pronta entrega ou pré-venda, refletido no checkout e na página do produto",
            "Nova faixa \"Confiança\" na loja, com selos de garantia, entrega e segurança",
            "Nova página de Suporte, com formulário de contato por e-mail",
            "Loja carrega mais produtos automaticamente ao rolar no celular",
            "Corrigido: o menu de categorias da loja perdia o comportamento fixo (sticky) ao rolar a página",
            "Admin: dá pra vincular um periférico já cadastrado direto a uma faixa de preço da Tierlist (Custo Benefício), sem duplicar o cadastro",
        ...
        },
        {
          version: "v0.3.2",
          date: "18 de agosto",
          title: "Esgotado, filtro por condição e navegação de categorias redesenhada na loja",
          description: "A loja perdeu a lista de compras mas ganhou status de esgotado, filtro por condição, navegação por categorias redesenhada e produtos em destaque; comentários e descrições de produto passaram a suportar destaque de texto.",
          items: [
            "Produto esgotado: quando marcado como esgotado, a página mostra o status e esconde o botão de compra",
            "Barra de formatação de texto ganhou opção de destacar (highlight) trechos, além de negrito e itálico",
            "Badge de Aura e o de missões diárias foram unificados em um só componente na TopBar",
            "Descrições de produto agora suportam o mesmo destaque de texto dos comentários",
            "Lista de compras removida da loja: funcionalidade lançada na v0.3.0 foi descontinuada",
            "Navegação da loja reformulada: menu de categorias com submenu (mega menu) e nova barra de categorias fixa no topo",
            "Filtro por condição do produto (Novo, Usado, Aberto) na loja",
            "Marcas passaram a aparecer agrupadas por categoria nos filtros",
            "Página da loja e o painel admin reorganizados, com suporte a produtos em destaque",
            "Ajustes visuais no card de produto, no carrinho e no combobox",
          ],
        },
        {
          version: "v0.3.1",
          date: "17 de agosto",
          title: "Preço promocional, estoque opcional e variantes com identidade visual na loja",
          description: "Loja ganhou preço promocional com histórico, estoque opcional, variantes com cor/ícone/imagem própria e limite de compra diária; o modal de login foi redesenhado.",
          items: [
            "Correções no checkout via PIX e nas páginas de produto/loja identificadas logo após o lançamento da v0.3.0",
            "Formulário de produto (admin) reformulado: variantes ganharam cor (swatch), ícone e imagem própria, mostrada no carrinho e, quando selecionada, no carrossel do produto",
            "Preço promocional \"De/Por\" em produtos e variantes, com histórico de preço registrado e exibido em gráfico no admin",
            "Estoque virou opcional: produto sem controle de estoque nunca esgota; quem tem estoque numérico continua funcionando como antes",
            "Até 3 imagens exclusivas por variante, além da imagem de capa",
            "Preço mínimo de R$6,00 por produto/variante, reforçado direto no banco",
            "Limite de 15 unidades por produto a cada 24h para produtos sem estoque cadastrado, evitando compra em atacado",
            "Modal de login/cadastro redesenhado: alternância Entrar/Criar conta com indicador animado, botão de fechar e efeito de brilho",
            "Checagem de tipos (typecheck) passou a rodar automaticamente a cada push",
          ],
        },
        {
          version: "v0.3.0",
        ...
        },
        {
          ...
          items: [
            ...
            "Seletor de idioma saiu do topo do site e passou pra Preferências da conta",
          ],
        },
        {
          version: "v0.2.2",
  ...
  "en-US": {
    ...
    admin: {
      ...
      tierlistForm: {
        ...
        linkedStoreProduct: "Linked Loja products",
      ...
      tierlistPage: {
        ...
        noPriceBandDesc: "Price under R$50 (or unset): falls into no band. Drag it onto a band or fix the price in the form.",
    ...
    changelog: {
      ...
      entries: [
        ...
        },
        {
          version: "v0.3.9",
          date: "September 11",
          title: "Personal tierlist gets customizable tiers and image export",
          description: "The personal tierlist (VIP) moved out of the profile's summary card into its own tab inside the Tierlist page, with tiers that are fully yours (name, color, and count) plus a button to download your board ready to share.",
          items: [
            "New \"My Tierlist\" tab inside /tierlist brings the personal tierlist (VIP-only) together in one place, replacing the summary card that used to live on the profile",
            "Tiers are fully yours: rename them, pick any color, have 2 to 6 tiers, and add, remove, or reorder however you like",
            "\"Download image\" button generates a share-ready PNG, capped at 6 peripherals per row so it doesn't get too wide",
            "Other members' profiles got the \"View tierlist\" link back, shown whenever the person has ranked at least one peripheral",
          ],
        },
        {
          version: "v0.3.8",
        ...
        },
        {
          ...
          items: [
            ...
            "For the first few weeks, GIF search may be unavailable for a few minutes during peak hours, and this fades over time. When it happens, just try again later; the rest of the comment/post works normally",
          ],
        },
        {
          version: "v0.3.6",
          date: "September 2",
          title: "PSU category in the Tierlist, revamped affiliate payouts, and a shipping address in checkout",
          description: "Peripherals got a PSU category with a full bench-test datasheet, and the IEM category got its own fields and tags. The affiliate program got a share link and a revamped payout screen, and checkout now accepts a shipping address filled in after purchase.",
          items: [
            "New PSU category (⚡ psu) in the Tierlist and the peripheral database: bench-test datasheet (ripple, efficiency, and temperature under normal load, overload, and a maximum stress test), 80 Plus and Cybenetics certifications, and General, National, and Cost-Benefit tabs",
            "The IEM category got its own fields (drivers, impedance, sensitivity, connector, plug, material, microphone) and a tuning curve, plus dozens of new tags for sound signature and shell build",
            "\"Sunano's Comments\" became \"Expert Comments\" across every peripheral category, with an optional author shown alongside the comment",
            "A \"Copy affiliate link\" button is now available on any page for approved affiliates, generating the link with your referral code baked in",
            "Revamped affiliate payout screen: PIX key validated and masked by type, ability to cancel a payout still under review, a R$20 minimum, and up to 3 simultaneous pending payouts",
            "New page listing every review for a peripheral, alongside the highlight carousel that already existed on the product page",
            "Checkout: skip the shipping address at purchase time and fill it in later from \"My Orders\"",
            "Checkout/cart: removing a single item (trash icon or reducing quantity to zero) now asks for confirmation; clearing the whole cart no longer does",
            "The PIX payment screen got a visual countdown of the time left before it expires",
            "Fixed: the promo price wasn't showing up in the \"starting at\" price of products linked to a peripheral",
            "Redesigned peripheral photo gallery: click to zoom and drag to pan the enlarged image, replacing the mouse-following magnifier",
            "Home: community numbers (peripherals, reviews, topics) now overlay every slide of the banner carousel, and the separate strip below it was removed",
            "Admin: products can now be pinned to the \"Best Sellers\" section on the Home page, with manual drag-to-reorder",
          ],
        },
        {
          version: "v0.3.5",
        ...
        },
        {
          ...
          description: "Sunano carried out its first wave of bans, the Damnatio Memoriae, against accounts caught artificially farming Aura, using multi-accounting and automation to inflate balance, streak, and ranking position.",
          items: [
            "Damnatio Memoriae: first wave of bans applied against accounts artificially farming Aura, using multi-accounting and automation (bots) to mass-generate likes, comments, and daily missions, inflating balance, streak, and ranking position without genuine site use",
        ...
        },
        {
          version: "v0.3.3",
          date: "August 19",
          title: "Variant groups, pre-orders, and saved forum posts",
          description: "The store got combinable variant groups (e.g. Color + Size), a sale type (ready stock/pre-order), and a new Support page; the forum got saved posts, and a sticky-menu bug in the store was fixed.",
          items: [
            ...
            "Variant groups: a product can now have more than one option group at once (e.g. Color and Size), each with its own options and price adjustment",
            "Sale type per product: ready stock or pre-order, reflected in checkout and on the product page",
            "New \"Trust\" strip in the store, with warranty, shipping, and security badges",
            "New Support page with an email contact form",
            "The store now loads more products automatically as you scroll on mobile",
            "Fixed: the store's category menu lost its sticky behavior when scrolling the page",
            "Admin: you can now link an already-registered peripheral directly to a Tierlist price band (Cost-Benefit), without duplicating the entry",
        ...
        },
        {
          version: "v0.3.2",
          date: "August 18",
          title: "Sold out status, condition filter, and redesigned category navigation in the store",
          description: "The store lost its wishlist feature but gained sold-out status, a condition filter, redesigned category navigation, and featured products; comments and product descriptions now support text highlighting.",
          items: [
            "Sold out products: when marked sold out, the page shows the status and hides the buy button",
            "Text formatting toolbar got a highlight option, alongside bold and italic",
            "Aura balance and daily missions badges merged into a single component in the TopBar",
            "Product descriptions now support the same text highlighting as comments",
            "Wishlists removed from the store: the feature launched in v0.3.0 has been discontinued",
            "Store navigation overhauled: category menu with a mega menu submenu and a new sticky category bar",
            "Condition filter (New, Used, Opened) in the store",
            "Brands are now grouped by category in filters",
            "The store page and the admin panel were reorganized, with support for featured products",
            "Visual tweaks to the product card, cart, and combobox",
          ],
        },
        {
          version: "v0.3.1",
          date: "August 17",
          title: "Promo pricing, optional stock, and variant visuals in the store",
          description: "The store got promo pricing with price history, optional stock, variants with their own color/icon/image, and a daily purchase limit; the login modal was redesigned.",
          items: [
            "Fixes to PIX checkout and product/store pages found right after the v0.3.0 launch",
            "Admin product form overhaul: variants now have their own color (swatch), icon, and image, shown in the cart and, when selected, in the product carousel",
            "\"Was/Now\" promo pricing for products and variants, with price history logged and shown as a chart in admin",
            "Stock became optional: products without stock tracking never sell out; numeric stock still works exactly as before",
            "Up to 3 dedicated images per variant, on top of the cover image",
            "Minimum price of R$6.00 per product/variant, enforced at the database level",
            "15-unit daily purchase limit per product for items without tracked stock, to prevent bulk buying",
            "Redesigned login/sign-up modal: animated Login/Sign up toggle, close button, and glow effect",
            "Type checking now runs automatically on every push",
          ],
        },
        {
          version: "v0.3.0",
        ...
        },
        {
          ...
          items: [
            "Mercado: new peer-to-peer marketplace replacing Bazar, where any member can list their own item with an OLX link",
        ...
        },
        {
          ...
          items: [
            ...
            "Language selector moved out of the top bar and now lives in account Preferences",
          ],
        },
        {
          version: "v0.2.2",
