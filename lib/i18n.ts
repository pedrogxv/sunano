      ...
      entries: [
        ...
        },
        {
          ...
          items: [
            ...
            "Home: os números da comunidade (periféricos, reviews, tópicos) agora aparecem sobre qualquer slide do carrossel de banners — a faixa separada abaixo dele foi removida",
      ...
      entries: [
        ...
        },
        {
          ...
          items: [
            ...
            "Home: community numbers (peripherals, reviews, topics) now overlay every slide of the banner carousel — the separate strip below it was removed",
