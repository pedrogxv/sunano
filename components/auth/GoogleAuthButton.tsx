...
export function GoogleAuthButton({ label, next = "/forum" }: GoogleAuthButtonProps) {
  ...
  async function handleClick() {
    ...
    // Em caso de sucesso o navegador é redirecionado para o Google, então o
    ...
    if (oauthError) {
      ...
      setLoading(false)
      // Log útil no console para diagnosticar configuração do Supabase/Google.
      console.error("[GoogleAuthButton] signInWithOAuth falhou:", oauthError.message)
    }
  }
